...
def parse_args(extra_args_provider=None, defaults={},
    ...
    """Parse all arguments."""
    parser = argparse.ArgumentParser(description='Megatron-GW Arguments',
                                     allow_abbrev=False)
...
def _add_network_size_args(parser):
    ...
    group.add_argument('--onnx-safe', type=bool, required=False,
                       ...
                       'Torch ONNX exporter')
    group.add_argument('--no-binary-head', action='store_false',
...
def _add_regularization_args(parser):
    ...
    group.add_argument('--adam-eps', type=float, default=1e-08,
                       ...
                       'numerical stability of adam')
    group.add_argument('--lamb-eps', type=float, default=1e-06,
                       help='Term added to the denominator to improve'
                       'numerical stability of lamb')
...
def _add_validation_args(parser):
    ...
    group.add_argument('--eval-iters', type=int, default=1,
...
def _add_data_args(parser):
    ...
    group.add_argument('--dets', type=str, default='H1',
